<template>
  <v-section :fullHeight="props.fullHeight" :noPadding="props.noPadding" class="flex flex-wrap flex-row md:flex-nowrap items-start justify-center">
    <div class="flex flex-col items-center md:items-start justify-center w-full md:w-6/12 md:h-full mt-xl md:mt-0">
    ...
    <div class="w-full md:w-6/12 flex flex-col items-center md:items-end justify-center md:h-full relative">
